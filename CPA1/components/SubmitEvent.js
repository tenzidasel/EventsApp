  ...
  <View style={{flexDirection:'row',
      ...
      <Text>
         log is {JSON.stringify(log)}
                    ...
                    :
                     <Button 
                     title="DEBUGGING INFO " color="#2196F3" onPress={() => {setView(true)}}/>            
  ...
  <View style={styles.container}>
      ...
      <View>
        <View style={{flexDirection:'row',
                    ...
                    fontSize: '30'}}>       
                 <Text style={{fontSize:56}}>Submit Event</Text>
         </View>
        ...
        <View style={{flex: 5}}>
            <View style={styles.userInput}>
                <Text>Submit information about your event! Enter Below:  
                </Text>
